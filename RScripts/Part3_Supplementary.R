...
working_dir = "/home/onur/workspace/rnaseq/de/ballgown/ref_only" 
setwd(working_dir)
...
gene_expression[1:3,c("FPKM.SRR12662528_expression","FPKM.SRR12662551_expression","FPKM.SRR12662556_expression","FPKM.SRR12662532_expression")]
...
#View expression values for the transcripts of a particular gene symbol of chromosome 22.  e.g. 'ZNF548'
#First determine the rows in the data.frame that match 'ZNF548', aka. ENSG00000128311, then display only those rows of the data.frame
i = row.names(gene_expression) == "ENSG00000234851"
gene_expression[i,]


#What if we want to view values for a list of genes of interest all at once? 
#genes_of_interest = c("RPL23AP42", "RPL23A", "RPS8", "AC064799.1")
genes_of_interest = c("ENSG00000234851","ENSG00000198242","ENSG00000142937","ENSG00000212664")
...
min(gene_expression[,"FPKM.SRR12662528_expression"])
max(gene_expression[,"FPKM.SRR12662528_expression"])
...
data_columns=c(1:6)
short_names=c("adV_1","adV_2","adV_3","virus_pos_1","virus_pos_2","virus_pos_3")
...
x = gene_expression[,"FPKM.SRR12662528_expression"]
y = gene_expression[,"FPKM.SRR12662551_expression"]
plot(x=log2(x+min_nonzero), y=log2(y+min_nonzero), pch=16, col="blue", cex=0.25, xlab="FPKM (adV, Replicate 1)", ylab="FPKM (adV, Replicate 2)", main="Comparison of expression values for a pair of replicates")
...
smoothScatter(x=log2(x+min_nonzero), y=log2(y+min_nonzero), xlab="FPKM (adV, Replicate 1)", ylab="FPKM (adV, Replicate 2)", main="Comparison of expression values for a pair of replicates", colramp=colors, nbin=200)
...
plotCor("FPKM.SRR12662528_expression", "FPKM.SRR12662521_expression", "adv_1 vs virus_pos_1", "tomato2")
plotCor("FPKM.SRR12662551_expression", "FPKM.SRR12662530_expression", "adv_2 vs virus_pos_2", "royalblue2")
...
par(mfrow=c(1,2))
plotCor2("FPKM.SRR12662528_expression", "FPKM.SRR12662521_expression", "adv_1 vs virus_pos_1", "tomato2")
plotCor2("FPKM.SRR12662551_expression", "FPKM.SRR12662530_expression", "adv_2 vs virus_pos_2", "royalblue2")
...
hist(results_genes[sig,"de"], breaks=50, col="seagreen", xlab="log2(Fold change) adv vs virus_pos", main="Distribution of differential expression values")
...
gene_expression[,"adv"]=apply(gene_expression[,c(1:3)], 1, mean)
gene_expression[,"virus_pos"]=apply(gene_expression[,c(4:6)], 1, mean)

x=log2(gene_expression[,"adv"]+min_nonzero)
y=log2(gene_expression[,"virus_pos"]+min_nonzero)

plot(x=x, y=y, pch=16, cex=0.25, xlab="adv FPKM (log2)", ylab="virus_pos FPKM (log2)", main="adv vs virus_pos FPKMs")
abline(a=0, b=1)
xsig=x[sig]
ysig=y[sig]
